...
export interface VendorWarehouseCreate_createWarehouse_warehouse {
    __typename: "VendorWarehouse";
    warehouse: string;
    vendorId: string;
    
}
export interface VendorCreate_createVendor_vendor{
  __typename:"VendorCreate";
  shopName: string;
  user: string;
}
export interface VendorWarehouseCreate_createVendorWarehouse {
    __typename: "VendorWarehouseCreate";
    vendorWarehouse: VendorWarehouseCreate_createWarehouse_warehouse | null;
}

export interface VendorCreate_createVendor{
  __typename: "VendorCreate";
  vendor: VendorCreate_createVendor_vendor | null;
}
...
export interface VendorWarehouseVariables {
  input: VendorWarehouseCreateInput;
}
